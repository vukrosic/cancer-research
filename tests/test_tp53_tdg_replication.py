...
from candrel import arid1a_atr_replication as base
from candrel import tp53_mdm2_replication as engine
from candrel.tp53_tdg_replication import ANALYSIS_EXPOSED, ANALYSIS_REFERENCE, Context, T0Stop, grouped_contexts, verify_endpoint_hash


def test_analysis_groups_use_tp53_labels():
...
def test_wrapper_restores_base_globals():
...
def test_tdg_target_is_bound_in_module():
    from candrel.tp53_tdg_replication import TARGET_COLUMN
    assert TARGET_COLUMN == "TDG (6996)"
