...
from candrel.brca12_cip2a_replication import ANALYSIS_EXPOSED, ANALYSIS_REFERENCE, Context, T0Stop, grouped_contexts, verify_endpoint_hash
...
def test_cip2a_target_is_bound_in_module():
    from candrel.brca12_cip2a_replication import TARGET_COLUMN
    assert TARGET_COLUMN == "CIP2A (57650)"
