...
from candrel.smad4_brd4_replication import ANALYSIS_EXPOSED, ANALYSIS_REFERENCE, Context, T0Stop, grouped_contexts, verify_endpoint_hash


def test_analysis_groups_use_smad4_labels():
...
def test_brd4_target_is_bound_in_module():
    from candrel.smad4_brd4_replication import TARGET_COLUMN
    assert TARGET_COLUMN == "BRD4 (23476)"
