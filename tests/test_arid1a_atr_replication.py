...
from candrel.arid1a_atr_replication import ANALYSIS_EXPOSED, ANALYSIS_REFERENCE, Context, T0Stop, grouped_contexts, verify_endpoint_hash


def test_analysis_groups_use_arid1a_labels():
...
def test_atr_target_is_bound_in_module():
    from candrel.arid1a_atr_replication import TARGET_COLUMN
    assert TARGET_COLUMN == "ATR (545)"
