"""Bounded CDKN2A-proxy to PELO dependency reliability replication."""
...
EXPERIMENT_ID = "EXP-20260822-025"
PAIR_ID = "CDKN2A_damaging_to_PELO"
STATUS_COLUMN = "CDKN2A (1029)"
TARGET_COLUMN = "PELO (53918)"
SOURCES = ("Avana", "KY")
LOADER_EXPOSED = "matrix_intact"
LOADER_REFERENCE = "damaging"
ANALYSIS_EXPOSED = "damaging"
ANALYSIS_REFERENCE = "matrix_intact"
EXPECTED_MODULE_PATH = "src/candrel/cdkn2a_pelo_replication.py"
ENGINE_MODULE_PATH = "src/candrel/tp53_mdm2_replication.py"
PROJECT_PATH = "pyproject.toml"
SELECTION_SEAL_PATH = "experiments/EXP-20260822-025/selection_seal.json"
REQUIRED_BASE_COMMIT = "b903b994a040965a88067a9fd27c2eb8c3da8e95"
EXPECTED_HASHES = {
...
DESIGN_SEEDS = {"Avana": 20262500, "KY": 20262600}
INFERENCE_SEEDS = {"Avana": 20272500, "KY": 20272600}
EXPECTED_ROSTER_SHA256 = "df50a72ac86b161e16ebc5a2eb2b2f5c8d35151d94da4046c375f5ab0f603bb5"
EXPECTED_DESIGN_RECEIPT_NORMALIZED_SHA256 = "6eefe76f9b4b1edda505488f14deba56c23491fedf7098950417cfac06571886"
...
def verify_implementation_boundary(manifest_path: Path) -> dict[str, object]:
    try:
        ...
        if manifest["experiment_id"] != EXPERIMENT_ID or manifest["entrypoint"] != ".venv/bin/python -m candrel.cdkn2a_pelo_replication":
        ...
        expected_design = {"mean_shift": engine.NORMAL_MEAN_SHIFT, "null_permutations": engine.PERMUTATIONS, "alternative_simulations": engine.DESIGN_SIMULATIONS, "planning_power_seeds": DESIGN_SEEDS, "expected_critical_delta": {"Avana": -0.1147076674084564, "KY": -0.19471153846153846}, "expected_power": {"Avana": 0.8958, "KY": 0.5265}, "minimum_power_for_confirmatory_label": engine.MIN_CONFIRMATORY_POWER, "frozen_label": "FEASIBILITY_ONLY"}
...
def validate_staged(stage: Path, result: dict[str, object]) -> None:
    if {p.name for p in stage.iterdir() if p.is_file()} != EXPECTED_RESULT_FILES:
        raise IntegrityError("EXP025 staged file set drift")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest-file", default="experiments/EXP-20260822-025/manifest.json")
    parser.add_argument("--results-dir", default="experiments/EXP-20260822-025/results")
    parser.add_argument("--error-receipt", default="experiments/EXP-20260822-025/error_receipt.json")
    parser.add_argument("--pre-endpoint-receipt", default="experiments/EXP-20260822-025/pre_endpoint_receipt.json")
    return parser
