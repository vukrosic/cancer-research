...
EXPERIMENT_ID = "EXP-20260822-020"
PAIR_ID = "TP53_damaging_to_WEE1"
STATUS_COLUMN = "TP53 (7157)"
TARGET_COLUMN = "WEE1 (7465)"
SOURCES = ("Avana", "KY")
LOADER_EXPOSED = "matrix_intact"
LOADER_REFERENCE = "damaging"
ANALYSIS_EXPOSED = "damaging"
ANALYSIS_REFERENCE = "matrix_intact"
EXPECTED_MODULE_PATH = "src/candrel/tp53_wee1_replication.py"
...
EXPECTED_STATUS_COUNTS = {
    "Avana": {ANALYSIS_EXPOSED: 610, ANALYSIS_REFERENCE: 365},
    "KY": {ANALYSIS_EXPOSED: 233, ANALYSIS_REFERENCE: 82},
}
EXPECTED_MIXED_LINEAGES = {"Avana": 25, "KY": 16}
DESIGN_SEEDS = {"Avana": 20262000, "KY": 20262100}
INFERENCE_SEEDS = {"Avana": 20272000, "KY": 20272100}
EXPECTED_ROSTER_SHA256 = "61060e6ef0c24ad1bb3acc2fbe75e9ad5f8908df505d20290cbab2189557b376"
EXPECTED_DESIGN_RECEIPT_NORMALIZED_SHA256 = "2e4f35e611521930017c299c684b3ab2e3ff56f522d1ef5dd80708216a0d598e"
...
def verify_implementation_boundary(manifest_path: Path) -> dict[str, object]:
    try:
        ...
        if manifest["selection_seal"]["sealed_before_endpoint_access"] is not True or manifest["selection_seal"]["protocol_commit"] != "cc8a055434b54f31d5125ec27412ab1867751536":
            raise ValueError("selection seal contract drift")
        expected_design = {"mean_shift": engine.NORMAL_MEAN_SHIFT, "null_permutations": engine.PERMUTATIONS, "alternative_simulations": engine.DESIGN_SIMULATIONS, "planning_power_seeds": DESIGN_SEEDS, "expected_critical_delta": {"Avana": -0.07859134565733761, "KY": -0.14327062228654125}, "expected_power": {"Avana": 0.9948, "KY": 0.7564}, "minimum_power_for_confirmatory_label": engine.MIN_CONFIRMATORY_POWER, "frozen_label": "FEASIBILITY_ONLY"}
...
def validate_staged(stage: Path, result: dict[str, object]) -> None:
    if {p.name for p in stage.iterdir() if p.is_file()} != EXPECTED_RESULT_FILES:
        raise IntegrityError("EXP020 staged file set drift")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest-file", default="experiments/EXP-20260822-020/manifest.json")
    parser.add_argument("--results-dir", default="experiments/EXP-20260822-020/results")
    parser.add_argument("--error-receipt", default="experiments/EXP-20260822-020/error_receipt.json")
    parser.add_argument("--pre-endpoint-receipt", default="experiments/EXP-20260822-020/pre_endpoint_receipt.json")
    return parser
