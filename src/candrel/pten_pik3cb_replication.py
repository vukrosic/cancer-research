...
EXPERIMENT_ID = "EXP-20260822-019"
PAIR_ID = "PTEN_damaging_to_PIK3CB"
STATUS_COLUMN = "PTEN (5728)"
TARGET_COLUMN = "PIK3CB (5291)"
SOURCES = ("Avana", "KY")
LOADER_EXPOSED = "matrix_intact"
LOADER_REFERENCE = "damaging"
ANALYSIS_EXPOSED = "damaging"
ANALYSIS_REFERENCE = "matrix_intact"
EXPECTED_MODULE_PATH = "src/candrel/pten_pik3cb_replication.py"
ENGINE_MODULE_PATH = "src/candrel/tp53_mdm2_replication.py"
PROJECT_PATH = "pyproject.toml"
SELECTION_SEAL_PATH = "experiments/EXP-20260822-019/selection_seal.json"
REQUIRED_BASE_COMMIT = "d061a93c239e48944e8fec3d54f6b4ae0460224c"
EXPECTED_HASHES = {
...
EXPECTED_STATUS_COUNTS = {"Avana": {ANALYSIS_EXPOSED: 94, ANALYSIS_REFERENCE: 881}, "KY": {ANALYSIS_EXPOSED: 38, ANALYSIS_REFERENCE: 277}}
EXPECTED_MIXED_LINEAGES = {"Avana": 19, "KY": 11}
DESIGN_SEEDS = {"Avana": 20261900, "KY": 20262000}
INFERENCE_SEEDS = {"Avana": 20271900, "KY": 20272000}
EXPECTED_ROSTER_SHA256 = "73222b7a148f333399d580107e1ab64672b0920678f3a2a9789b3440f9c2d953"
EXPECTED_DESIGN_RECEIPT_NORMALIZED_SHA256 = "d97ea261c675fabecfe37508ad12fbee6ae62d02daecef9ab5690fe157d6fb85"
...
def verify_implementation_boundary(manifest_path: Path) -> dict[str, object]:
    try:
        ...
        if manifest["experiment_id"] != EXPERIMENT_ID or manifest["entrypoint"] != "uv run candrel-pten-pik3cb-replication":
        ...
        if manifest["selection_seal"]["sealed_before_endpoint_access"] is not True or manifest["selection_seal"]["protocol_commit"] != "96ee16fd12c59c9a2e4d4eb38800502f89f07faf":
            raise ValueError("selection seal contract drift")
        expected_design = {"mean_shift": engine.NORMAL_MEAN_SHIFT, "null_permutations": engine.PERMUTATIONS, "alternative_simulations": engine.DESIGN_SIMULATIONS, "planning_power_seeds": DESIGN_SEEDS, "expected_critical_delta": {"Avana": -0.12334911537503115, "KY": -0.19418758256274768}, "expected_power": {"Avana": 0.8562, "KY": 0.5375}, "minimum_power_for_confirmatory_label": engine.MIN_CONFIRMATORY_POWER, "frozen_label": "FEASIBILITY_ONLY"}
...
def validate_staged(stage: Path, result: dict[str, object]) -> None:
    if {p.name for p in stage.iterdir() if p.is_file()} != EXPECTED_RESULT_FILES:
        raise IntegrityError("EXP019 staged file set drift")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest-file", default="experiments/EXP-20260822-019/manifest.json")
    parser.add_argument("--results-dir", default="experiments/EXP-20260822-019/results")
    parser.add_argument("--error-receipt", default="experiments/EXP-20260822-019/error_receipt.json")
    parser.add_argument("--pre-endpoint-receipt", default="experiments/EXP-20260822-019/pre_endpoint_receipt.json")
    return parser
