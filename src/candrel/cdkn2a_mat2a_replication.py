"""Bounded CDKN2A-proxy to MAT2A dependency reliability replication."""
...
EXPERIMENT_ID = "EXP-20260822-037"
PAIR_ID = "CDKN2A_damaging_to_MAT2A"
STATUS_COLUMN = "CDKN2A (1029)"
TARGET_COLUMN = "MAT2A (4144)"
SOURCES = ("Avana", "KY")
LOADER_EXPOSED = "matrix_intact"
LOADER_REFERENCE = "damaging"
ANALYSIS_EXPOSED = "damaging"
ANALYSIS_REFERENCE = "matrix_intact"
EXPECTED_MODULE_PATH = "src/candrel/cdkn2a_mat2a_replication.py"
ENGINE_MODULE_PATH = "src/candrel/tp53_mdm2_replication.py"
PROJECT_PATH = "pyproject.toml"
SELECTION_SEAL_PATH = "experiments/EXP-20260822-037/selection_seal.json"
REQUIRED_BASE_COMMIT = "e12edbdb9e1d1526d2e32c7f93e01a77786855b6"
EXPECTED_HASHES = {
...
EXPECTED_STATUS_COUNTS = {
    "Avana": {ANALYSIS_EXPOSED: 110, ANALYSIS_REFERENCE: 865},
    "KY": {ANALYSIS_EXPOSED: 37, ANALYSIS_REFERENCE: 278},
}
EXPECTED_MIXED_LINEAGES = {"Avana": 19, "KY": 11}
DESIGN_SEEDS = {"Avana": 20263700, "KY": 20263800}
INFERENCE_SEEDS = {"Avana": 20273700, "KY": 20273800}
EXPECTED_ROSTER_SHA256 = "df50a72ac86b161e16ebc5a2eb2b2f5c8d35151d94da4046c375f5ab0f603bb5"
EXPECTED_DESIGN_RECEIPT_NORMALIZED_SHA256 = "21169dee5a4756e3869f5b7068c606633c1f808373fe91b5ecfc5567ed2b861a"
...
def verify_implementation_boundary(manifest_path: Path) -> dict[str, object]:
    try:
        ...
        if manifest["experiment_id"] != EXPERIMENT_ID or manifest["entrypoint"] != ".venv/bin/python -m candrel.cdkn2a_mat2a_replication":
        ...
        expected_design = {"mean_shift": engine.NORMAL_MEAN_SHIFT, "null_permutations": engine.PERMUTATIONS, "alternative_simulations": engine.DESIGN_SIMULATIONS, "planning_power_seeds": DESIGN_SEEDS, "expected_critical_delta": {"Avana": -0.11592150515881045, "KY": -0.19230769230769232}, "expected_power": {"Avana": 0.8906, "KY": 0.5361}, "minimum_power_for_confirmatory_label": engine.MIN_CONFIRMATORY_POWER, "frozen_label": "FEASIBILITY_ONLY"}
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest-file", default="experiments/EXP-20260822-037/manifest.json")
    parser.add_argument("--results-dir", default="experiments/EXP-20260822-037/results")
    parser.add_argument("--error-receipt", default="experiments/EXP-20260822-037/error_receipt.json")
    parser.add_argument("--pre-endpoint-receipt", default="experiments/EXP-20260822-037/pre_endpoint_receipt.json")
    return parser
