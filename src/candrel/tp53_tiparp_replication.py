"""Bounded TP53-proxy to TIPARP dependency transportability replication."""
...
EXPERIMENT_ID = "EXP-20260822-028"
PAIR_ID = "TP53_damaging_to_TIPARP"
STATUS_COLUMN = "TP53 (7157)"
TARGET_COLUMN = "TIPARP (25976)"
SOURCES = ("Avana", "KY")
LOADER_EXPOSED = "matrix_intact"
LOADER_REFERENCE = "damaging"
ANALYSIS_EXPOSED = "damaging"
ANALYSIS_REFERENCE = "matrix_intact"
EXPECTED_MODULE_PATH = "src/candrel/tp53_tiparp_replication.py"
ENGINE_MODULE_PATH = "src/candrel/tp53_mdm2_replication.py"
PROJECT_PATH = "pyproject.toml"
EXPECTED_PROTOCOL_COMMIT = "9eb3860"
REQUIRED_BASE_COMMIT = "9eb3860"
EXPECTED_HASHES = {
...
DESIGN_SEEDS = {"Avana": 20262800, "KY": 20262900}
INFERENCE_SEEDS = {"Avana": 20272800, "KY": 20272900}
EXPECTED_ROSTER_SHA256 = "61060e6ef0c24ad1bb3acc2fbe75e9ad5f8908df505d20290cbab2189557b376"
EXPECTED_DESIGN_RECEIPT_NORMALIZED_SHA256 = "1a31edafdac547fd67c65a4c962f3a802e6cb4766201d52982019c0b858a5437"
...
def verify_implementation_boundary(manifest_path: Path) -> dict[str, object]:
    try:
        ...
        if manifest["experiment_id"] != EXPERIMENT_ID or manifest["entrypoint"] != ".venv/bin/python -m candrel.tp53_tiparp_replication":
...
def validate_staged(stage: Path, result: dict[str, object]) -> None:
    if {path.name for path in stage.iterdir() if path.is_file()} != EXPECTED_RESULT_FILES:
        raise IntegrityError("EXP028 staged file set drift")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest-file", default="experiments/EXP-20260822-028/manifest.json")
    parser.add_argument("--results-dir", default="experiments/EXP-20260822-028/results")
    parser.add_argument("--error-receipt", default="experiments/EXP-20260822-028/error_receipt.json")
    parser.add_argument("--pre-endpoint-receipt", default="experiments/EXP-20260822-028/pre_endpoint_receipt.json")
    return parser
